...
public class ToyStorelmpl implements ToyStorelnt {
    ...
    private Repository<sale_details> saleDetailsRepository;
    ...
    public ToyStorelmpl() throws SQLException {
        ...
        this.saleDetailsRepository = new SaleDetailsRepositoryJDBCimpl();
        this.saleRepository = new SaleRepositoryJDBCimpl();
    }
    ...
    @Override
    public void addSaleDetails(SaleDetailsDTO saleDetailsDTO) {
